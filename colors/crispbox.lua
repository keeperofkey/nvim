...
hi(0, 'Special', { fg = c.cyan, bg = 'none' })
...
hi(0, 'RenderMarkdownCode', { bg = 'none', bold = true, italic = true })
hi(0, 'RenderMarkdownH1', { fg = c.red, bold = true })
hi(0, 'RenderMarkdownH2', { fg = c.orange, bold = true })
hi(0, 'RenderMarkdownH3', { fg = c.yellow, bold = true })
hi(0, 'RenderMarkdownH4', { fg = c.green, bold = true })
hi(0, 'RenderMarkdownH5', { fg = c.cyan, bold = true })
hi(0, 'RenderMarkdownH6', { fg = c.blue, bold = true })
hi(0, 'RenderMarkdownH1Bg', { bg = 'none' })
hi(0, 'RenderMarkdownH2Bg', { bg = 'none' })
hi(0, 'RenderMarkdownH3Bg', { bg = 'none' })
hi(0, 'RenderMarkdownH4Bg', { bg = 'none' })
hi(0, 'RenderMarkdownH5Bg', { bg = 'none' })
hi(0, 'RenderMarkdownH6Bg', { bg = 'none' })
hi(0, 'RenderMarkdownTableHead', { fg = c.yellow, bold = true })
hi(0, 'RenderMarkdownTableRow', { fg = c.dim })
